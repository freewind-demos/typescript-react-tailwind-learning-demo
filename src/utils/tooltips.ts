export const tooltips = {
  ...
  // 任意值语法的说明
  'text-[20px]': '使用方括号语法可以指定任意的像素值，不受预设值限制',
  'font-[600]': '使用方括号语法可以指定任意的字重值',
  'leading-[2.5]': '使用方括号语法可以指定任意的行高倍数',
  'text-[#ff0000]': '使用方括号语法可以直接指定颜色的十六进制值',
  'text-[rgb(255,0,0)]': '使用方括号语法可以直接指定颜色的RGB值',
  'text-[hsl(0,100%,50%)]': '使用方括号语法可以直接指定颜色的HSL值'
};
